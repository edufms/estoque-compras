  ...
  async function submit(e) {
    ...
    try {
      ...
      if (totalValidades > qtd) {
        throw new Error(
          "A soma das quantidades por validade não pode exceder a quantidade total do produto",
        );
      }
      const dados = {
        ...form,
  ...
  return (
    <div>
      ...
      <div className="toolbar">
        <div className="seg">
          <button className={visao === "lista" ? "active" : ""} onClick={() => setVisao("lista")}>
            Lista
          </button>
          <button className={visao === "card" ? "active" : ""} onClick={() => setVisao("card")}>
            Card
          </button>
        </div>
                    ...
                    {isAdmin && (
                      <td data-label="Ações">
                        <div className="td-actions">
                          <button className="small ghost" onClick={() => setModal(p)}>
                            Editar
                          </button>
                          <button className="small danger" onClick={() => excluirClicado(p.id)}>
                            Excluir
                          </button>
                        </div>
                      </td>
